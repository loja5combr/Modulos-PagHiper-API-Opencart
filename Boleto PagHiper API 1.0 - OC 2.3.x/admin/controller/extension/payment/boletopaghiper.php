...
class ControllerExtensionPaymentBoletoPagHiper extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/payment/boletopaghiper', 'salvo=true&token=' . $this->session->data['token'], true));
		}
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/extension', 'type=payment&token=' . $this->session->data['token'], true)
		);

		$data['breadcrumbs'][] = array(
			'text' => $this->language->get('heading_title'),
			'href' => $this->url->link('extension/payment/boletopaghiper', 'token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('extension/payment/boletopaghiper', 'token=' . $this->session->data['token'], true);
