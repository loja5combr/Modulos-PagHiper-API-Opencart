...
<div class="rowd" style="text-align:center;">
...
<div class="col-xs-9">
<input type="text" onkeypress="return isNumberKey(event)" style="max-width:300px;text-align:center" maxlength="14" style="width:40%" value="<?php echo $fiscal;?>" class="input_100P form-control" id="fiscal" name="fiscal" />
</div>
</div>

<div class="form-group buttons">
<div class="col-xs-9 col-xs-offset-3">
<div><input type="submit" class="button" id="button-confirm" value="Confirmar Pedido"></div>
</div>
</div>
</form>
